...
.. code-block:: bash
   ...
   git clone https://github.com/joosthub/pytorch-nlp-tutorial-sf2018.git

If you do not have git or do not want to use it, you can also
`download the repository as a zip file <https://github.com/joosthub/pytorch-nlp-tutorial-sf2018/archive/master.zip>`_
